defmodule AiReality2Transnet.CloudConnectorTest do
  @moduledoc """
  ...
  describe "init/1 with empty cloud_nodes config" do
    test "starts successfully with no cloud nodes configured" do
      ...
      assert Application.get_env(:ai_reality2_transnet, :cloud_nodes, []) == []
    end
    ...
    test "state structure has expected shape when no nodes configured" do
      ...
      cloud_configs = Application.get_env(:ai_reality2_transnet, :cloud_nodes, [])
