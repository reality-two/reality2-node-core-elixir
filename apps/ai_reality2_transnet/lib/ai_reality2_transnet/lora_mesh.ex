defmodule AiReality2Transnet.LoRaMesh do
  @moduledoc """
  ...
  ```elixir
  config :ai_reality2_transnet, :lora,
    enabled: true,
  ...
  **Author**
  ...
  def init(opts) do
    ...
    lora_config = Application.get_env(:ai_reality2_transnet, :lora, [])
  ...
  defp bridge_to_ble(message) do
    if Code.ensure_loaded?(AiReality2Transnet.R2Mesh) do
      ...
      if byte_size(message.payload) <= 18 do
        ...
        AiReality2Transnet.R2Mesh.handle_incoming(encoded)
      end
    end
  end
