...
/// ```elixir
/// # Start watching
/// {:ok, handle} = AiReality2Transnet.Action.start_watch(self(), "hci0")
///
...
///
/// # Stop watching
/// :ok = AiReality2Transnet.Action.stop_watch(handle)
/// ```
...
/// ```elixir
/// # Start GATT server
/// {:ok, handle} = AiReality2Transnet.Action.start_gatt_server(
...
///
/// # Stop GATT server
/// :ok = AiReality2Transnet.Action.stop_gatt_server(handle)
/// ```
