defmodule Reality2Wfs.Test do
  ...
  ## Usage
      ...
      Reality2Wfs.Test.test_remote_send(peer_node_id, sentant_id)

      # Test broadcast
      Reality2Wfs.Test.test_broadcast("*")
  ...
  def test_remote_send(peer_node_id, sentant_id) do
    ...
    case Reality2Transnet.PeerManager.get_peer(peer_node_id) do
      {:ok, peer_info} ->
