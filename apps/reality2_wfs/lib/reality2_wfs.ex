defmodule Reality2Wfs do
  ...
  ## Quick Start
      ...
      Reality2Wfs.broadcast("*", "event_name")
  ...
  **Author**
  ...
  ## Examples
      ...
      # Send by ID
      Reality2Wfs.send_to("a1b2c3...", "turn_on")

      # Send by name
      Reality2Wfs.send_to("device1_sensor", "read_temperature", %{unit: "celsius"})
  ...
  ## Examples
      ...
      # Broadcast to all
      Reality2Wfs.broadcast("*", "shutdown")

      # Broadcast to devices matching pattern
      Reality2Wfs.broadcast("sensor_*", "read_data")

      # Broadcast to specific list
      Reality2Wfs.broadcast([id1, id2, id3], "sync")
  """
  ...
  ## Example
      ...
      case Reality2Wfs.locate("device1_sensor") do
        {:ok, :local} ->
  ...
  """
  defdelegate locate(sentant_identifier), to: Reality2Wfs.Router
  ...
  """
  defdelegate routing_table, to: Reality2Wfs.Router, as: :get_routing_table
  ...
  """
  defdelegate refresh, to: Reality2Wfs.Router, as: :refresh_topology
end
