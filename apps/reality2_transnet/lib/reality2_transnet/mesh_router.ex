defmodule Reality2Transnet.MeshRouter do
  @moduledoc """
  ...
  **Author**
  ...
  @transport_modules [
    Reality2Transnet.Transports.WiFiTransport,
    Reality2Transnet.Transports.InternetTransport,
    Reality2Transnet.Transports.LoRaTransport,
    Reality2Transnet.Transports.BLETransport
  ]
  ...
  defp route_to_target(message, target, stats, transports) do
    ...
    if target_node_id do
      ...
      if Code.ensure_loaded?(Reality2Transnet.PeerManager) do
        case Reality2Transnet.PeerManager.best_transport(target_node_id) do
  ...
  defp handle_presence(message) do
    ...
    case Jason.decode(message.payload) do
      {:ok, payload} ->
        ...
        Reality2Transnet.PeerManager.register_peer(node_id, %{
          node_name: node_name,
          sentants: sentants
        })
