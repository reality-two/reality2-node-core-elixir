defmodule Reality2Transnet.Wifi do
  @moduledoc """
  ...
  **Hardware:**
  ...
  - `Reality2Transnet.Bluetooth` - BLE discovery layer
  - `Reality2Transnet.ConnectionManager` - Hotspot/client connection management
  - `Reality2Transnet.ConnectionAssessor` - Connection quality assessment and handover
  - `Reality2Transnet.GattProtocol` - Join offer transmission
  ...
  **Author**
  ...
  ## Examples
      ...
      iex> Reality2Transnet.Wifi.list_adapters()
      {:ok, [
        %{
          transport: "wifi",
          interface: "wlan0",
  ...
  def generate_psk_for_node(node_name) do
    ...
    secret = Application.get_env(:reality2_transnet, :psk_secret, "R2TransnetSharedSecret2024")
