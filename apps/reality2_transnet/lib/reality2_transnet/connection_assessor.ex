defmodule Reality2Transnet.ConnectionAssessor do
  @moduledoc """
  ...
  **Author**
  ...
  alias Reality2Transnet.{PeerManager, ConnectionManager}
  ...
  defp maybe_yield_hosting do
    case safe_get_connection_status() do
      {:ok, %{state: :hosting_ap}} ->
        my_priority = Reality2Transnet.Wifi.get_hosting_priority()
                        ...
                        if should_we_host?(my_priority, my_node_id, updated_peers) do
                          ...
                          case ConnectionManager.start_hosting() do
                            {:ok, config} ->
                              ...
                              Reality2Transnet.Wifi.report_hotspot_success()

                            {:error, err} ->
                              Logger.warning("#{log_prefix()} Failed to start hosting: #{inspect(err)}")
                              Reality2Transnet.Wifi.report_hotspot_failure()
                          end
                        else
  ...
  defp try_connect_to_r2_hotspot do
    ...
    case Reality2Transnet.Wifi.select_adapter_for_client() do
      {:ok, %{interface: interface, preserves_internet: preserves}} ->
        ...
        case Reality2Transnet.Wifi.find_r2_hotspots(interface) do
          {:ok, []} ->
          ...
          {:ok, hotspots} ->
            ...
            case other_hotspots do
              ...
              [best | _] ->
                ...
                case Reality2Transnet.Wifi.connect_to_network(interface, best.ssid, best.psk) do
                  {:ok, _uuid} ->
                    ...
                    Reality2Transnet.Wifi.report_client_connected()
  ...
  defp check_for_hosting_peer do
    ...
    case hosting_peer do
      ...
      nil ->
        ...
        my_node_name = Reality2.Bootstrap.get(:node_name, "")
        case Reality2Transnet.Wifi.find_r2_hotspots(nil) do
          {:ok, hotspots} ->
