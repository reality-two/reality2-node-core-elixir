defmodule Reality2Transnet.Action do
  # *******************************************************************************************************************************************
  @moduledoc """
  ...
  use Rustler, otp_app: :reality2_transnet, crate: "reality2transnet"
  ...
  Discovery is suspended but the watch task stays alive. Call `resume_watching/1`
  to restart scanning.
  ...
  `:ok` on success
  """
  def pause_watching(_handle), do: :erlang.nif_error(:nif_not_loaded)
  ...
  `:ok` on success
  """
  def resume_watching(_handle), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def start_broadcast(_company_id, _uuid_str, _hive_compressed, _rssi_at_1m, _node_name, _hosting_priority, _adapter_name),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  ## Parameters
  - `handle` - The handle returned from `start_broadcast/8`
...
"""
  ...
  # See: Reality2Transnet.Wifi module for WiFi operations.
