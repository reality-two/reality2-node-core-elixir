defmodule Reality2Transnet.DiscoverySupervisor do
  @moduledoc """
  ...
  **Author**
  ...
  def init(_init_arg) do
    children = [
      ...
      %{
        id: Reality2Transnet.Bluetooth,
        start: {Reality2Transnet.Bluetooth, :start_link, [Reality2Transnet.Bluetooth]},
        restart: :transient
      },
      # LoRa mesh - also transient (hardware may not be present)
      %{
        id: Reality2Transnet.LoRaMesh,
        start: {Reality2Transnet.LoRaMesh, :start_link, [[]]},
        restart: :transient
      }
    ]
