defmodule Reality2Transnet.ConnectionSupervisor do
  @moduledoc """
  ...
  **Author**
  ...
  def init(_init_arg) do
    ...
    children = [
      ...
      %{
        id: Reality2Transnet.ConnectionManager,
        start: {Reality2Transnet.ConnectionManager, :start_link, [[]]},
        restart: :permanent,
      ...
      %{
        id: Reality2Transnet.ConnectionAssessor,
        start: {Reality2Transnet.ConnectionAssessor, :start_link, [[]]},
        restart: :permanent
      }
    ]
