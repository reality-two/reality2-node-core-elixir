defmodule Reality2Transnet.MixProject do
  use Mix.Project

  def project do
    [
      app: :reality2_transnet,
      version: "0.1.14",
      build_path: "../../_build",
  ...
  def application do
    [
      ...
      mod: {Reality2Transnet.Application, []}
    ]
  end
  ...
  defp deps do
    [
      ...
      # Note: reality2_wfs is NOT a compile-time dependency
