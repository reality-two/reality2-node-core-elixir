...
// // -------------------------------------------------------------------------------------------
// rustler::init!("Elixir.Reality2Transnet.Action", load = load);
...
//! ## Calling from Elixir
//!
//! All functions are exposed via `Reality2Transnet.Action` module:
//!
//! ```elixir
//! # Start beacon
//! {:ok, beacon} = Reality2Transnet.Action.start_broadcast(...)
//!
//! # Start discovery
//! {:ok, watch} = Reality2Transnet.Action.start_watch(...)
//!
//! # Start GATT server
//! {:ok, gatt} = Reality2Transnet.Action.start_gatt_server(...)
//! ```
