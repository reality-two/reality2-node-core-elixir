    ...
    let block = {
      ...
      fields: {
        ...
        description: R2.JSONPath(automation, "description")
          ? R2.JSONPath(automation, "description")
          : "",
      },
      inputs: {
        transitions: {},
      ...
      let transitions_block = transitions.reduceRight((acc, transition) => {
        ...
        if (event == "__internal") {
          ...
          if (parameters && Object.keys(parameters).length > 0) {
            ...
            transition_block =
              reality2_simple_transition_no_params.construct(transition);
            if (transition_block && acc) {
              transition_block["next"] = { block: acc };
            }
          }
          ...
          if (!to) {
            transition_block =
              reality2_start_transition_simple.construct(transition);
            if (transition_block && acc) {
              transition_block["next"] = { block: acc };
            }
            ...
            transition_block =
              reality2_start_transition_no_params.construct(transition);
            if (transition_block && acc) {
              transition_block["next"] = { block: acc };
            }
          }
          ...
          if (parameters && Object.keys(parameters).length > 0) {
            ...
            transition_block =
              reality2_transition_no_params.construct(transition);
            if (transition_block && acc) {
              transition_block["next"] = { block: acc };
            }
          }
