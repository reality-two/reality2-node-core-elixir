    ...
    if (R2.JSONPath(action, "parameters.value.data")) {
      block["inputs"]["value"] = {
        block: reality2_action_set_data.construct(
          R2.JSONPath(action, "parameters.value"),
        ),
      };
      ...
      block["inputs"]["value"] = {
        block: reality2_action_set_calc_binary.construct(
          R2.JSONPath(action, "parameters.value.expr"),
        ),
      };
    } else {
      block["inputs"]["value"] = {
