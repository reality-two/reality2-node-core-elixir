...
function process(block: any, generator: any): string | [string, number] {
  ...
  const value1 = R2.JSONPath(value1expr, "expr")
    ? R2.JSONPath(value1expr, "expr")
    : value1expr;
  const value2 = R2.JSONPath(value2expr, "expr")
    ? R2.JSONPath(value2expr, "expr")
    : value2expr;
  ...
  if (expr) {
    ...
    if (parameters.length == 1) {
      ...
      if (typeof parameters[0] == "object") {
        ...
        block["inputs"]["value1"] = {
          block: reality2_action_set_value.construct(parameters[0]),
        };
      }
      ...
      if (typeof parameters[1] == "object") {
        ...
        block["inputs"]["value2"] = {
          block: reality2_action_set_value.construct(parameters[1]),
        };
      }
